...
const getSocketId = async (request: T.NextApiRequestToken, response: NextApiResponse) => {
...
const modifySocketId = async (request: T.NextApiRequestToken, response: NextApiResponse) => {
